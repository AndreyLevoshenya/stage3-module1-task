...
public class NewsValidator implements Validator {
    ...
    @Override
    public boolean validate(NewsDtoResponse news, DataRepository dataSource) throws TitleLengthIsWrongException, ContentLengthIsWrongException, AuthorNotFoundException {
        ...
        else if(!dataSource.readAllAuthors().contains(new Author(news.getAuthorId(), ""))) {
