...
public class FileDataRepository implements DataRepository {
    ...
    public FileDataRepository(String newsFilename, String authorFilename) {
        newsDataSource = new NewsDataSource(newsFilename);
        authorDataSource = new AuthorDataSource(authorFilename);
        newsData = newsDataSource.getInfo();
        authorsData = authorDataSource.getInfo();
    }

    public FileDataRepository(List<NewsModel> newsData, List<AuthorModel> authorsData) {
